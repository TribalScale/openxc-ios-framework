...
final public class VehicleMessage : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> VehicleMessage {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> VehicleMessage.Builder {
      ...
      if let jsonValueType = jsonMap["type"] as? String {
        resultDecodedBuilder.type = try .fromString(str: jsonValueType)
      }
...
final public class CanMessage : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> CanMessage {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> CanMessage.Builder {
      ...
      if let jsonValueFrameFormat = jsonMap["frameFormat"] as? String {
        resultDecodedBuilder.frameFormat = try CanMessage.FrameFormat.fromString(str: jsonValueFrameFormat)
      }
      return resultDecodedBuilder
    }
...
final public class ControlCommand : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> ControlCommand {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> DiagnosticControlCommand.Builder {
      ...
      if let jsonValueAction = jsonMap["action"] as? String {
        resultDecodedBuilder.action = try DiagnosticControlCommand.Action.fromString(str: jsonValueAction)
      }
      return resultDecodedBuilder
    }
...
final public class PayloadFormatCommand : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> PayloadFormatCommand {
    return try PayloadFormatCommand.Builder.fromJSONToBuilder(data:data).build()
  }
  override public func getDescription(indent:String) throws -> String {
    var output = ""
    if (hasFormat) {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> PayloadFormatCommand.Builder {
      ...
      if let jsonValueFormat = jsonMap["format"] as? String {
        resultDecodedBuilder.format = try PayloadFormatCommand.PayloadFormat.fromString(str: jsonValueFormat)
      }
      return resultDecodedBuilder
    }
    override class public func fromJSONToBuilder(data:Data) throws -> PayloadFormatCommand.Builder {
      let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
      guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
        throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
      }
...
final public class PredefinedObd2RequestsCommand : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> PredefinedObd2RequestsCommand {
    return try PredefinedObd2RequestsCommand.Builder.fromJSONToBuilder(data:data).build()
  }
  override public func getDescription(indent:String) throws -> String {
    var output = ""
    if hasEnabled {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    override class public func fromJSONToBuilder(data:Data) throws -> PredefinedObd2RequestsCommand.Builder {
      let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
      guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
        throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
      }
...
final public class NetworkOperatorSettings : GeneratedMessage {
  ...
  //Nested type declaration start
    ...
    final public class NetworkDescriptor : GeneratedMessage {
      ...
      override class public func fromJSON(data:Data) throws -> NetworkOperatorSettings.NetworkDescriptor {
        return try NetworkOperatorSettings.NetworkDescriptor.Builder.fromJSONToBuilder(data:data).build()
      }
      override public func getDescription(indent:String) throws -> String {
        var output = ""
        if hasPlmn {
      ...
      final public class Builder : GeneratedMessageBuilder {
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> NetworkOperatorSettings.NetworkDescriptor.Builder {
          ...
          if let jsonValueNetworkType = jsonMap["networkType"] as? String {
            resultDecodedBuilder.networkType = try NetworkOperatorSettings.NetworkDescriptor.NetworkType.fromString(str: jsonValueNetworkType)
          }
          return resultDecodedBuilder
        }
        override class public func fromJSONToBuilder(data:Data) throws -> NetworkOperatorSettings.NetworkDescriptor.Builder {
          let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
          guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
            throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
          }
  ...
  override class public func fromJSON(data:Data) throws -> NetworkOperatorSettings {
    return try NetworkOperatorSettings.Builder.fromJSONToBuilder(data:data).build()
  }
  override public func getDescription(indent:String) throws -> String {
    var output = ""
    if hasAllowDataRoaming {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> NetworkOperatorSettings.Builder {
      ...
      if let jsonValueOperatorSelectMode = jsonMap["operatorSelectMode"] as? String {
        resultDecodedBuilder.operatorSelectMode = try NetworkOperatorSettings.OperatorSelectMode.fromString(str: jsonValueOperatorSelectMode)
      }
    ...
    override class public func fromJSONToBuilder(data:Data) throws -> NetworkOperatorSettings.Builder {
      let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
      guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
        throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
      }
...
final public class NetworkDataSettings : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> NetworkDataSettings {
    return try NetworkDataSettings.Builder.fromJSONToBuilder(data:data).build()
  }
  override public func getDescription(indent:String) throws -> String {
    var output = ""
    if hasApn {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    override class public func fromJSONToBuilder(data:Data) throws -> NetworkDataSettings.Builder {
      let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
      guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
        throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
      }
...
final public class ServerConnectSettings : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> ServerConnectSettings {
    return try ServerConnectSettings.Builder.fromJSONToBuilder(data:data).build()
  }
  override public func getDescription(indent:String) throws -> String {
    var output = ""
    if hasHost {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    override class public func fromJSONToBuilder(data:Data) throws -> ServerConnectSettings.Builder {
      let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
      guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
        throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
      }
...
final public class ModemConfigurationCommand : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> ModemConfigurationCommand {
    return try ModemConfigurationCommand.Builder.fromJSONToBuilder(data:data).build()
  }
  override public func getDescription(indent:String) throws -> String {
    var output = ""
    if hasNetworkOperatorSettings {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    override class public func fromJSONToBuilder(data:Data) throws -> ModemConfigurationCommand.Builder {
      let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
      guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
        throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
      }
...
final public class RtcconfigurationCommand : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> RtcconfigurationCommand {
    return try RtcconfigurationCommand.Builder.fromJSONToBuilder(data:data).build()
  }
  override public func getDescription(indent:String) throws -> String {
    var output = ""
    if hasUnixTime {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    override class public func fromJSONToBuilder(data:Data) throws -> RtcconfigurationCommand.Builder {
      let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
      guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
        throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
      }
...
final public class CommandResponse : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> CommandResponse {
    return try CommandResponse.Builder.fromJSONToBuilder(data:data).build()
  }
  override public func getDescription(indent:String) throws -> String {
    var output = ""
    if (hasType) {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    override class public func fromJSONToBuilder(data:Data) throws -> CommandResponse.Builder {
      let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
      guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
        throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
      }
...
final public class DiagnosticRequest : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> DiagnosticRequest {
    return try DiagnosticRequest.Builder.fromJSONToBuilder(data:data).build()
  }
  override public func getDescription(indent:String) throws -> String {
    var output = ""
    if hasBus {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> DiagnosticRequest.Builder {
      ...
      if let jsonValueDecodedType = jsonMap["decodedType"] as? String {
        resultDecodedBuilder.decodedType = try DiagnosticRequest.DecodedType.fromString(str: jsonValueDecodedType)
      }
      return resultDecodedBuilder
    }
    override class public func fromJSONToBuilder(data:Data) throws -> DiagnosticRequest.Builder {
      let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
      guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
        throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
      }
...
final public class DiagnosticResponse : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> DiagnosticResponse {
...
final public class DynamicField : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> DynamicField {
    return try DynamicField.Builder.fromJSONToBuilder(data:data).build()
  }
  override public func getDescription(indent:String) throws -> String {
    var output = ""
    if (hasType) {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    override class public func fromJSONToBuilder(data:Data) throws -> DynamicField.Builder {
      let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
      guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
        throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
      }
...
final public class SimpleMessage : GeneratedMessage {
  ...
  override class public func fromJSON(data:Data) throws -> SimpleMessage {
    return try SimpleMessage.Builder.fromJSONToBuilder(data:data).build()
  }
  override public func getDescription(indent:String) throws -> String {
    var output = ""
    if hasName {
  ...
  final public class Builder : GeneratedMessageBuilder {
    ...
    override class public func fromJSONToBuilder(data:Data) throws -> SimpleMessage.Builder {
      let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
      guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
        throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
      }
